...
exports.refundedOrder = function(track, settings){
  ...
  products.map(function(product, i){
    ...
    transaction['pr' + productIndex + 'br'] = product.brand();
    transaction['pr' + productIndex + 'va'] = product.variant();
    transaction['pr' + productIndex + 'cc'] = product.coupon();
    transaction['pr' + productIndex + 'ps'] = product.position();
  });
